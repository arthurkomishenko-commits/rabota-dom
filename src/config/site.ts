 ...
 * `/404` — одна страница на три языка (Pages отдаёт её на любой адрес):
 * у неё нет ни языковых версий, ни собственного «правильного» адреса.
 */
export const NON_LOCALIZED_PREFIXES = ['/admin', '/__ui', '/404'] as const;
